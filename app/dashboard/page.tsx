    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-6xl px-4 py-8">
        <div className="mb-8">
          ...
          <h1 className="mt-3 text-4xl font-semibold tracking-tight">Your financial dashboard</h1>
          ...
          <>
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              ...
              <SummaryCard
                ...
                subtitle={balance >= 0 ? "You are in positive territory." : "Your spending is above your income."}
              />
            </div>
